...
DATA_DIR = "/scratch/kalidas_1/project/data/synthetic/apriltag_6dof_dataset_rendered/images"
OUTPUT_DIR = os.path.join(PROJECT_ROOT, "tmp", "apriltag_6dof_hybrid_output_v2")
...
DIMENSION_NAMES = ['norm_x', 'norm_y', 'norm_z', 'norm_roll', 'norm_pitch', 'norm_yaw']
